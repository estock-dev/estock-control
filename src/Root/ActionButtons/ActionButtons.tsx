...
const ActionButtons: React.FC = () => {
    ...
    const cardData = [
        ...
        { id: 3, text: 'Exportar Listas', onClickHandler: () => navigate('/list-export')},
        { id: 4, text: 'Adicionar Produto', onClickHandler: () => navigate('/add-product')},
    ];
    return (
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '48px', justifyContent: 'center', marginTop: 30 }}>
            {cardData.map(card => (
